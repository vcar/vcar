...
class User(db.Model, UserMixin):
    """ User Model:
        the user can be a person or even a campany, it can manage drivers
        and vehicles.
    """
    __tablename__ = 'users'
    ...
    avatar = db.Column(db.String(STRING_LEN), default=DEFAULT_AVATAR)
    ...
    def __init__(self, username, email, password, fullname=None, avatar=None, role=USER, status=INACTIVE):
        self.fullname = fullname  # fullname.title()
